...
public abstract class NavigationBarView extends FrameLayout {
    ...
    public NavigationBarView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (attributes.hasValue(R.styleable.NavigationBarView_elevation)) {
            setElevation((float) attributes.getDimensionPixelSize(R.styleable.NavigationBarView_elevation, 0));
        }
        ...
        if (activeIndicatorStyleResId != 0) {
            ...
            setItemActiveIndicatorWidth(activeIndicatorAttributes.getDimensionPixelSize(R.styleable.NavigationBarActiveIndicator_android_width, 0));
            setItemActiveIndicatorHeight(activeIndicatorAttributes.getDimensionPixelSize(R.styleable.NavigationBarActiveIndicator_android_height, 0));
            setItemActiveIndicatorMarginHorizontal(activeIndicatorAttributes.getDimensionPixelOffset(R.styleable.NavigationBarActiveIndicator_marginHorizontal, 0));
            setItemActiveIndicatorColor(MaterialResources.getColorStateList(context2, activeIndicatorAttributes, R.styleable.NavigationBarActiveIndicator_android_color));
            ColorStateList colorStateList = backgroundTint;
            setItemActiveIndicatorShapeAppearance(ShapeAppearanceModel.builder(context2, activeIndicatorAttributes.getResourceId(R.styleable.NavigationBarActiveIndicator_shapeAppearance, 0), 0).build());
    ...
    public void setItemRippleColor(ColorStateList itemRippleColor2) {
        if (this.itemRippleColor != itemRippleColor2) {
            ...
            this.menuView.setItemBackground(new RippleDrawable(RippleUtils.convertToRippleDrawableColor(itemRippleColor2), (Drawable) null, (Drawable) null));
