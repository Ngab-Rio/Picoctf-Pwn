...
public class MaterialColors {
    ...
    public static ColorRoles getColorRoles(int color, boolean isLightTheme) {
        if (isLightTheme) {
            return new ColorRoles(getColorRole(color, 40), getColorRole(color, 100), getColorRole(color, TONE_ACCENT_CONTAINER_LIGHT), getColorRole(color, 10));
        }
        return new ColorRoles(getColorRole(color, TONE_ACCENT_DARK), getColorRole(color, 10), getColorRole(color, 20), getColorRole(color, TONE_ON_ACCENT_CONTAINER_DARK));
    }
