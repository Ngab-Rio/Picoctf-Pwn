...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            obj = Result.m40constructorimpl(property == null ? null : Boolean.valueOf(Boolean.parseBoolean(property)));
        } catch (Throwable th) {
    ...
    public static final void m1561installSignalHandler$lambda1(Signal it) {
