...
public final class DelayKt {
    ...
    public static final Object m1517delayVtjQ1oo(long duration, Continuation<? super Unit> $completion) {
        Object delay = delay(m1518toDelayMillisLRDsOJo(duration), $completion);
    ...
    public static final long m1518toDelayMillisLRDsOJo(long $this$toDelayMillis) {
        if (Duration.m1352compareToLRDsOJo($this$toDelayMillis, Duration.Companion.m1455getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1371getInWholeMillisecondsimpl($this$toDelayMillis), 1);
        }
        return 0;
    }
}
