...
public final class ArrayBroadcastChannel<E> extends AbstractSendChannel<E> implements BroadcastChannel<E> {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:51:0x00ba, code lost:
        if (kotlinx.coroutines.DebugKt.getASSERTIONS_ENABLED() == false) goto L_0x00d5;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:55:0x00c2, code lost:
        if (r4 != kotlinx.coroutines.CancellableContinuationImplKt.RESUME_TOKEN) goto L_0x00c5;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:69:?, code lost:
        r1.buffer[(int) (r10 % ((long) getCapacity()))] = r3.getPollResult();
        setSize(r0 + 1);
        setTail(r10 + 1);
    ...
    private final void updateHead(kotlinx.coroutines.channels.ArrayBroadcastChannel.Subscriber<E> r26, kotlinx.coroutines.channels.ArrayBroadcastChannel.Subscriber<E> r27) {
        ...
        L_0x0032:
            ...
            return
        L_0x0049:
            long r8 = r25.computeMinHead()     // Catch:{ all -> 0x0140 }
            long r10 = r25.getTail()     // Catch:{ all -> 0x0140 }
            long r12 = r25.getHead()     // Catch:{ all -> 0x0140 }
            long r14 = kotlin.ranges.RangesKt.coerceAtMost((long) r8, (long) r10)     // Catch:{ all -> 0x0140 }
            int r0 = (r14 > r12 ? 1 : (r14 == r12 ? 0 : -1))
            if (r0 > 0) goto L_0x0061
            r6.unlock()
            return
        L_0x0061:
            int r0 = r25.getSize()     // Catch:{ all -> 0x0140 }
        L_0x0065:
            int r2 = (r12 > r14 ? 1 : (r12 == r14 ? 0 : -1))
            if (r2 >= 0) goto L_0x013b
            java.lang.Object[] r2 = r1.buffer     // Catch:{ all -> 0x0133 }
            r16 = r3
            int r3 = r25.getCapacity()     // Catch:{ all -> 0x012b }
            r17 = r4
            long r3 = (long) r3
            long r3 = r12 % r3
            int r3 = (int) r3     // Catch:{ all -> 0x0125 }
            r4 = 0
            r2[r3] = r4     // Catch:{ all -> 0x0125 }
            int r2 = r25.getCapacity()     // Catch:{ all -> 0x0125 }
            r18 = 1
        ...
        L_0x0086:
            r19 = 1
            long r12 = r12 + r19
            r1.setHead(r12)     // Catch:{ all -> 0x0125 }
            int r0 = r0 + -1
            r1.setSize(r0)     // Catch:{ all -> 0x0125 }
            if (r2 == 0) goto L_0x011b
        L_0x0094:
            kotlinx.coroutines.channels.Send r21 = r25.takeFirstSendOrPeekClosed()     // Catch:{ all -> 0x0125 }
        ...
        L_0x00a0:
            r16 = r21
            r3 = r16
            boolean r4 = r3 instanceof kotlinx.coroutines.channels.Closed     // Catch:{ all -> 0x0117 }
            if (r4 == 0) goto L_0x00ab
            r4 = r17
            goto L_0x0065
        L_0x00ab:
            r4 = 0
            kotlinx.coroutines.internal.Symbol r16 = r3.tryResumeSend(r4)     // Catch:{ all -> 0x0117 }
            r22 = r16
            r4 = r22
            if (r4 == 0) goto L_0x010c
            boolean r22 = kotlinx.coroutines.DebugKt.getASSERTIONS_ENABLED()     // Catch:{ all -> 0x0117 }
            if (r22 == 0) goto L_0x00d5
            r22 = 0
            r23 = r2
            kotlinx.coroutines.internal.Symbol r2 = kotlinx.coroutines.CancellableContinuationImplKt.RESUME_TOKEN     // Catch:{ all -> 0x00d0 }
        ...
        L_0x00c7:
            ...
            goto L_0x00d7
        L_0x00ca:
            java.lang.AssertionError r2 = new java.lang.AssertionError     // Catch:{ all -> 0x00d0 }
        ...
        L_0x00d5:
            r23 = r2
        L_0x00d7:
            java.lang.Object[] r2 = r1.buffer     // Catch:{ all -> 0x0117 }
            r22 = r4
            int r4 = r25.getCapacity()     // Catch:{ all -> 0x0117 }
            r24 = r5
            long r4 = (long) r4
            long r4 = r10 % r4
            int r4 = (int) r4     // Catch:{ all -> 0x010a }
            java.lang.Object r5 = r3.getPollResult()     // Catch:{ all -> 0x010a }
            r2[r4] = r5     // Catch:{ all -> 0x010a }
            int r2 = r0 + 1
            r1.setSize(r2)     // Catch:{ all -> 0x010a }
            long r4 = r10 + r19
            r1.setTail(r4)     // Catch:{ all -> 0x010a }
