...
class UComparisonsKt___UComparisonsKt {
    ...
    public static final int m1226maxOfMd2H83M(int a, int... other) {
        ...
        int max = a;
        int r1 = UIntArray.m194getSizeimpl(other);
        for (int i = 0; i < r1; i++) {
            max = UComparisonsKt.m1224maxOfJ1ME1BU(max, UIntArray.m193getpVg5ArA(other, i));
        }
        return max;
    }
    ...
    public static final long m1227maxOfR03FKyM(long a, long... other) {
        Intrinsics.checkNotNullParameter(other, "other");
        long max = a;
        int r2 = ULongArray.m272getSizeimpl(other);
        for (int i = 0; i < r2; i++) {
            max = UComparisonsKt.m1232maxOfeb3DHEI(max, ULongArray.m271getsVKNKU(other, i));
        }
        return max;
    }
    ...
    public static final byte m1230maxOfWr6uiD8(byte a, byte... other) {
        Intrinsics.checkNotNullParameter(other, "other");
        byte max = a;
        int r1 = UByteArray.m116getSizeimpl(other);
        for (int i = 0; i < r1; i++) {
            max = UComparisonsKt.m1225maxOfKr8caGY(max, UByteArray.m115getw2LRezQ(other, i));
        }
        return max;
    }
    ...
    public static final short m1234maxOft1qELG4(short a, short... other) {
        Intrinsics.checkNotNullParameter(other, "other");
        short max = a;
        int r1 = UShortArray.m376getSizeimpl(other);
        for (int i = 0; i < r1; i++) {
            max = UComparisonsKt.m1223maxOf5PvTz6A(max, UShortArray.m375getMh2AYeg(other, i));
        }
        return max;
    }
    ...
    public static final int m1238minOfMd2H83M(int a, int... other) {
        ...
        int r1 = UIntArray.m194getSizeimpl(other);
        for (int i = 0; i < r1; i++) {
            min = UComparisonsKt.m1236minOfJ1ME1BU(min, UIntArray.m193getpVg5ArA(other, i));
        }
        return min;
    }
    ...
    public static final long m1239minOfR03FKyM(long a, long... other) {
        ...
        int r2 = ULongArray.m272getSizeimpl(other);
        for (int i = 0; i < r2; i++) {
            min = UComparisonsKt.m1244minOfeb3DHEI(min, ULongArray.m271getsVKNKU(other, i));
        }
        return min;
    }
    ...
    public static final byte m1242minOfWr6uiD8(byte a, byte... other) {
        ...
        int r1 = UByteArray.m116getSizeimpl(other);
        for (int i = 0; i < r1; i++) {
            min = UComparisonsKt.m1237minOfKr8caGY(min, UByteArray.m115getw2LRezQ(other, i));
        }
        return min;
    }
    ...
    public static final short m1246minOft1qELG4(short a, short... other) {
        ...
        int r1 = UShortArray.m376getSizeimpl(other);
        for (int i = 0; i < r1; i++) {
            min = UComparisonsKt.m1235minOf5PvTz6A(min, UShortArray.m375getMh2AYeg(other, i));
        }
        return min;
    }
}
