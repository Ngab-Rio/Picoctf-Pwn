...
public final class UStringsKt {
    ...
    public static final String m1336toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m1338toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m1337toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
    ...
    public static final String m1335toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        int r0 = uIntOrNull.m185unboximpl();
        if (UnsignedKt.uintCompare(r0, UInt.m134constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m52boximpl(UByte.m58constructorimpl((byte) r0));
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int r0 = uIntOrNull.m185unboximpl();
        if (UnsignedKt.uintCompare(r0, UInt.m134constructorimpl(SupportMenu.USER_MASK)) > 0) {
            return null;
        }
        return UShort.m312boximpl(UShort.m318constructorimpl((short) r0));
    }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m134constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            if (UnsignedKt.uintCompare(result, limitBeforeMul) > 0) {
                ...
                limitBeforeMul = UnsignedKt.m387uintDivideJ1ME1BU(-1, uradix);
                if (UnsignedKt.uintCompare(result, limitBeforeMul) > 0) {
                    return null;
                }
            }
            int result2 = UInt.m134constructorimpl(result * uradix);
            int beforeAdding = result2;
            result = UInt.m134constructorimpl(UInt.m134constructorimpl(digit) + result2);
            if (UnsignedKt.uintCompare(result, beforeAdding) < 0) {
                return null;
            }
        }
        return UInt.m128boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m212constructorimpl((long) i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            if (UnsignedKt.ulongCompare(result, limitBeforeMul) > 0) {
                ...
                limitBeforeMul = UnsignedKt.m389ulongDivideeb3DHEI(-1, uradix);
                if (UnsignedKt.ulongCompare(result, limitBeforeMul) > 0) {
                    return null;
                }
            }
            long result2 = ULong.m212constructorimpl(result * uradix);
            long beforeAdding = result2;
            result = ULong.m212constructorimpl(ULong.m212constructorimpl(((long) UInt.m134constructorimpl(digit)) & 4294967295L) + result2);
        ...
        return ULong.m206boximpl(result);
    }
}
