...
public final class DurationConversionsJDK8Kt {
    private static final long toKotlinDuration(Duration $this$toKotlinDuration) {
        ...
        return kotlin.time.Duration.m1389plusLRDsOJo(DurationKt.toDuration($this$toKotlinDuration.getSeconds(), DurationUnit.SECONDS), DurationKt.toDuration($this$toKotlinDuration.getNano(), DurationUnit.NANOSECONDS));
    }

    /* renamed from: toJavaDuration-LRDsOJo  reason: not valid java name */
    private static final Duration m1515toJavaDurationLRDsOJo(long $this$toJavaDuration) {
        Duration ofSeconds = Duration.ofSeconds(kotlin.time.Duration.m1374getInWholeSecondsimpl($this$toJavaDuration), (long) kotlin.time.Duration.m1376getNanosecondsComponentimpl($this$toJavaDuration));
