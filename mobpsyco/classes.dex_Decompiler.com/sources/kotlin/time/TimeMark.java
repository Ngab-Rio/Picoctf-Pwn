...
public interface TimeMark {
    ...
    TimeMark m1489minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    TimeMark m1490plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m1491minusLRDsOJo(TimeMark $this, long duration) {
            return $this.m1490plusLRDsOJo(Duration.m1405unaryMinusUwyO8pc(duration));
        }

        public static boolean hasPassedNow(TimeMark $this) {
            return !Duration.m1386isNegativeimpl($this.m1488elapsedNowUwyO8pc());
        }
