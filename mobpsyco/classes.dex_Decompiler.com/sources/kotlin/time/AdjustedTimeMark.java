...
final class AdjustedTimeMark implements TimeMark {
    ...
    public long m1345elapsedNowUwyO8pc() {
        return Duration.m1388minusLRDsOJo(this.mark.m1488elapsedNowUwyO8pc(), this.adjustment);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1348plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1389plusLRDsOJo(this.adjustment, duration), (DefaultConstructorMarker) null);
    }
}
