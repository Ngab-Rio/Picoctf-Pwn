...
class FontProvider {
    ...
    static androidx.core.provider.FontsContractCompat.FontInfo[] query(android.content.Context r23, androidx.core.provider.FontRequest r24, java.lang.String r25, android.os.CancellationSignal r26) {
        /*
            ...
            java.lang.String[] r6 = new java.lang.String[]{r4, r5, r6, r7, r8, r9, r10}     // Catch:{ all -> 0x0116 }
            android.content.ContentResolver r4 = r23.getContentResolver()     // Catch:{ all -> 0x0116 }
            java.lang.String r7 = "query = ?"
            r0 = 1
            java.lang.String[] r8 = new java.lang.String[r0]     // Catch:{ all -> 0x0116 }
            java.lang.String r5 = r24.getQuery()     // Catch:{ all -> 0x0116 }
            r13 = 0
            r8[r13] = r5     // Catch:{ all -> 0x0116 }
            r9 = 0
            r5 = r11
            r10 = r26
            android.database.Cursor r5 = androidx.core.provider.FontProvider.Api16Impl.query(r4, r5, r6, r7, r8, r9, r10)     // Catch:{ all -> 0x0116 }
            r12 = r5
            if (r12 == 0) goto L_0x0103
            int r5 = r12.getCount()     // Catch:{ all -> 0x0116 }
            if (r5 <= 0) goto L_0x0103
            java.lang.String r5 = "result_code"
            int r5 = r12.getColumnIndex(r5)     // Catch:{ all -> 0x0116 }
            java.util.ArrayList r7 = new java.util.ArrayList     // Catch:{ all -> 0x0116 }
            r7.<init>()     // Catch:{ all -> 0x0116 }
            r2 = r7
            java.lang.String r7 = "_id"
            int r7 = r12.getColumnIndex(r7)     // Catch:{ all -> 0x0116 }
            java.lang.String r8 = "file_id"
            int r8 = r12.getColumnIndex(r8)     // Catch:{ all -> 0x0116 }
            java.lang.String r9 = "font_ttc_index"
            int r9 = r12.getColumnIndex(r9)     // Catch:{ all -> 0x0116 }
            java.lang.String r10 = "font_weight"
            int r10 = r12.getColumnIndex(r10)     // Catch:{ all -> 0x0116 }
            java.lang.String r14 = "font_italic"
            int r14 = r12.getColumnIndex(r14)     // Catch:{ all -> 0x0116 }
        L_0x0091:
            boolean r15 = r12.moveToNext()     // Catch:{ all -> 0x0116 }
            if (r15 == 0) goto L_0x00fe
            r15 = -1
            if (r5 == r15) goto L_0x00a4
            int r16 = r12.getInt(r5)     // Catch:{ all -> 0x009f }
            goto L_0x00a6
        L_0x009f:
            r0 = move-exception
            r17 = r3
        ...
        L_0x00a6:
            r17 = r16
            if (r9 == r15) goto L_0x00af
            int r16 = r12.getInt(r9)     // Catch:{ all -> 0x009f }
            goto L_0x00b1
        L_0x00af:
            r16 = r13
        L_0x00b1:
            ...
            long r19 = r12.getLong(r7)     // Catch:{ all -> 0x009f }
            r21 = r19
            r0 = r21
            android.net.Uri r19 = android.content.ContentUris.withAppendedId(r11, r0)     // Catch:{ all -> 0x009f }
            r0 = r19
            goto L_0x00ce
        L_0x00c4:
            long r0 = r12.getLong(r8)     // Catch:{ all -> 0x0116 }
            android.net.Uri r19 = android.content.ContentUris.withAppendedId(r3, r0)     // Catch:{ all -> 0x0116 }
            r0 = r19
        L_0x00ce:
            if (r10 == r15) goto L_0x00d5
            int r1 = r12.getInt(r10)     // Catch:{ all -> 0x009f }
            goto L_0x00d7
        L_0x00d5:
            r1 = 400(0x190, float:5.6E-43)
        L_0x00d7:
            if (r14 == r15) goto L_0x00e2
            int r15 = r12.getInt(r14)     // Catch:{ all -> 0x009f }
            r13 = 1
        ...
        L_0x00e4:
            ...
            r3 = r18
            r18 = r4
            androidx.core.provider.FontsContractCompat$FontInfo r4 = androidx.core.provider.FontsContractCompat.FontInfo.create(r0, r3, r1, r15, r13)     // Catch:{ all -> 0x00fc }
            r2.add(r4)     // Catch:{ all -> 0x00fc }
            r1 = r25
            r3 = r17
            r4 = r18
            r0 = 1
